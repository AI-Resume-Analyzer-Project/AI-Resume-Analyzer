...
function LoginScreen({ navigation }) {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      /*
       * Save the JWT token using AsyncStorage here.
       */
      ...
      Toast.show({
        ...
        text2: 'Welcome to AI Resume Analyzer.',
      });
    } catch (error) {
  ...
  const handleSignUp = () => {
    ...
    Toast.show({
      ...
      text2: 'Add registration screen navigation here.',
    });
  };
  ...
  const handleForgotPassword = () => {
    ...
    Toast.show({
      ...
      text2: 'Add forgot-password functionality here.',
    });
  };
