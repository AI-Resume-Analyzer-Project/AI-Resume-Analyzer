...
router.post('/upload', authenticate, authorize('candidate', 'recruiter', 'admin'), upload.single('resume'), controller.upload)
...
router.delete('/:id', authenticate, authorize('candidate', 'recruiter', 'admin'), v.id('id'), controller.remove)
